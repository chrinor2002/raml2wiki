...
function parseWithOptionsAndConfig(source, options, config, onSuccess, onError) {
...
function parseWithOptions(source, options, template, onSuccess, onError) {
    var config = {
        'template': require(template),
        'partials': {
            'resource': require('./resource.handlebars')
    ...
    parseWithOptionsAndConfig(source, options, config, onSuccess, onError);
}
...
module.exports.parseWithOptionsAndConfig = parseWithOptionsAndConfig;
